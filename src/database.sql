...
('React Infinity Run 4', 'NIKE', 'Corsa', 'UOMO', 42.0, 169.99, 12, 'Supporto e ammortizzazione fluida.', '/images/scarpa 1.png'),
('Air Winflo 10', 'NIKE', 'Corsa', 'UOMO', 44.0, 109.99, 20, 'Un passo equilibrato per la tua corsa.', '/images/scarpa 1.png'),
('Zoom Fly 5', 'NIKE', 'Corsa', 'UOMO', 43.0, 159.99, 10, 'Propulsione e resistenza per l''allenamento.', '/images/scarpa 1.png'),
('Air Zoom TR 1', 'NIKE', 'Corsa', 'UOMO', 42.5, 119.99, 9, 'Reattività versatile per ogni chilometro.', '/images/scarpa 1.png'),
('Zoom Rival M 9', 'NIKE', 'Corsa', 'UOMO', 41.0, 79.99, 6, 'Leggerezza e velocità su pista.', '/images/scarpa 1.png'),
('Revolution 6 NN', 'NIKE', 'Corsa', 'UOMO', 40.0, 64.99, 25, 'Comfort essenziale e design sostenibile.', '/images/scarpa 1.png'),
('Vaporfly 3', 'NIKE', 'Corsa', 'UOMO', 45.0, 259.99, 5, 'Per raggiungere la massima velocità.', '/images/scarpa 1.png'),
('Alphafly 2', 'NIKE', 'Corsa', 'UOMO', 43.5, 299.99, 4, 'La scarpa da maratona definitiva.', '/images/scarpa 1.png'),
('Pegasus Turbo', 'NIKE', 'Corsa', 'UOMO', 42.0, 149.99, 10, 'Ritorno di energia e leggerezza.', '/images/scarpa 1.png'),
('Structure 25', 'NIKE', 'Corsa', 'UOMO', 44.5, 139.99, 15, 'Stabilità dove serve di più.', '/images/scarpa 1.png'),
